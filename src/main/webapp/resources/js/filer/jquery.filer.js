...
(function($) {
				...
				f = {
					...
					_bindInput: function() {
						if(n.changeInput && o.size() > 0) {
							$('#upload_button').bind("click", f._clickHandler);
						}
						s.on({
							"focus": function() {
								o.addClass('focused');
					...
					_unbindInput: function() {
						if(n.changeInput && o.size() > 0) {
							$('#upload_button').unbind("click", f._clickHandler);
						}
					},
							...
							if(n.changeInput) {
								switch(typeof n.changeInput) {
									case "boolean":
										...
										o = $('<div class="col-lg-12"><div class="jFiler-input-button" id="upload_button">' +
											n.captions.button + '</div></div>');
										break;
									case "string":
									case "object":
										o = $(n.changeInput);
	...
	$.fn.filer.defaults = {
		...
		theme: 'default',
		templates: {
			box: '<ul id="list" class="jFiler-items-list jFiler-items-default"></ul>',
