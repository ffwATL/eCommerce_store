  ...
  $.fn.extend({
    stickyMojo: function(options) {
      ...
      function calculateLimits() {
        console.log(sticky.stickyTop2 - sticky.marg);
        return {
      ...
      function stick() {
        ...
        console.log('stickyTio: '+ tops.stickyTop+', tops.windowTop: ' + tops.windowTop + ', sticky.win.width(): ' + sticky.win.width()+
        ', sticky.breakPoint: ' + sticky.breakPoint);
